...
const FileForm = ({ form, onSubmit }) => {
  ...
  const beforeUpload = (file) => {
    ...
    if (!isValidType) {
      message.error(
        'You can only upload PDF, Word, Excel, PowerPoint, or image files!',
      )
  ...
  return (
    <div className="file-form-container">
      ...
      <Form
        ...
        requiredMark={false}
        className="form-content file-form"
      ...
      >
        ...
        <div className="form-content__section form-content__compact-section">
          <div className="form-content__section-header">
            ...
            <div className="form-content__section-title">File Details</div>
          </div>
        ...
        <div className="form-content__section">
          ...
          <div className="form-content__upload-container">
            {fileList.length === 0 ? (
              ...
              >
                <Dragger {...uploadProps} className="file-form__dragger">
              ...
              <div className="file-form__file-preview">
                <div className="file-form__file-info">
                  <div className="file-form__file-icon">
                    {getFileIcon(fileList[0])}
                  </div>
                  <div className="file-form__file-details">
                  ...
                  <Tooltip title="Remove file">
                    <Button
                      ...
                      icon={<DeleteOutlined />}
                      onClick={onRemove}
                      className="file-form__remove-btn"
                    />
                  </Tooltip>
                </div>
                {fileToBase64Loading && (
